...
Data must be synced first with the sync command.`,
  ...
  contentful-pp-cli analytics --type messages

  # Group by a field
  contentful-pp-cli analytics --type messages --group-by author_id

  # Top 10 most frequent values
  contentful-pp-cli analytics --type messages --group-by channel_id --limit 10 --json`,
