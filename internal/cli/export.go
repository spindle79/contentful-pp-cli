...
large datasets as it has no memory pressure.`,
  ...
  contentful-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  contentful-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  contentful-pp-cli export <resource> --format jsonl | jq '.id'`,
