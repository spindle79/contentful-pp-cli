...
Exit codes & warnings:
  ...
  contentful-pp-cli sync

  # Sync specific resources only
  contentful-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  contentful-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  contentful-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  contentful-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  contentful-pp-cli sync --latest-only`,
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	switch resource {
	case "ai_actions":
		return db.UpsertAiActions(data)
	case "api_keys":
		return db.UpsertApiKeys(data)
	case "app_installations":
		return db.UpsertAppInstallations(data)
	case "assets":
		return db.UpsertAssets(data)
	case "comments":
		return db.UpsertComments(data)
	case "content_type_snapshots":
		return db.UpsertContentTypeSnapshots(data)
	case "content_types":
		return db.UpsertContentTypes(data)
	case "delivery_assets":
		return db.UpsertDeliveryAssets(data)
	case "delivery_content_types":
		return db.UpsertDeliveryContentTypes(data)
	case "delivery_entries":
		return db.UpsertDeliveryEntries(data)
	case "delivery_locales":
		return db.UpsertDeliveryLocales(data)
	case "delivery_sync":
		return db.UpsertDeliverySync(data)
	case "editor_interfaces":
		return db.UpsertEditorInterfaces(data)
	case "entries":
		return db.UpsertEntries(data)
	case "entry_snapshots":
		return db.UpsertEntrySnapshots(data)
	case "environment_aliases":
		return db.UpsertEnvironmentAliases(data)
	case "environments":
		return db.UpsertEnvironments(data)
	case "extensions":
		return db.UpsertExtensions(data)
	case "locales":
		return db.UpsertLocales(data)
	case "organization_memberships":
		return db.UpsertOrganizationMemberships(data)
	case "organizations":
		return db.UpsertOrganizations(data)
	case "preview_api_keys":
		return db.UpsertPreviewApiKeys(data)
	case "preview_assets":
		return db.UpsertPreviewAssets(data)
	case "preview_entries":
		return db.UpsertPreviewEntries(data)
	case "release_actions":
		return db.UpsertReleaseActions(data)
	case "releases":
	...
	case "space_memberships":
		return db.UpsertSpaceMemberships(data)
	case "spaces":
	...
	case "webhook_calls":
		return db.UpsertWebhookCalls(data)
	case "webhooks":
...
var syncResourceTiers = map[string]string{
	...
	"assets":                   "cma",
	"comments":                 "cma",
	"content_type_snapshots":   "cma",
	"content_types":            "cma",
	"delivery_assets":          "cda",
	"delivery_content_types":   "cda",
	"delivery_entries":         "cda",
	"delivery_sync":            "cda",
	"entries":                  "cma",
	"entry_snapshots":          "cma",
	"environments":             "cma",
	"organization_memberships": "cma",
	"preview_api_keys":         "cma",
	"preview_assets":           "cpa",
	"preview_entries":          "cpa",
	"releases":                 "cma",
	"roles":                    "cma",
	"space_memberships":        "cma",
	"tags":                     "cma",
	"tasks":                    "cma",
	"webhook_calls":            "cma",
	"webhooks":                 "cma",
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "ai_actions", ParentTable: "spaces", ParentIDParam: "space_id", PathTemplate: "/spaces/{space_id}/environments/{environment_id}/ai_actions"},
		{Name: "api_keys", ParentTable: "spaces", ParentIDParam: "space_id", PathTemplate: "/spaces/{space_id}/api_keys"},
		{Name: "assets", ParentTable: "spaces", ParentIDParam: "space_id", PathTemplate: "/spaces/{space_id}/environments/{environment_id}/assets"},
		{Name: "comments", ParentTable: "spaces", ParentIDParam: "space_id", PathTemplate: "/spaces/{space_id}/environments/{environment_id}/entries/{entry_id}/comments"},
		{Name: "content_type_snapshots", ParentTable: "spaces", ParentIDParam: "space_id", PathTemplate: "/spaces/{space_id}/environments/{environment_id}/content_types/{content_type_id}/snapshots"},
		{Name: "content_types", ParentTable: "spaces", ParentIDParam: "space_id", PathTemplate: "/spaces/{space_id}/environments/{environment_id}/content_types"},
		{Name: "delivery_assets", ParentTable: "spaces", ParentIDParam: "space_id", PathTemplate: "/spaces/{space_id}/environments/{environment_id}/assets"},
		{Name: "delivery_content_types", ParentTable: "spaces", ParentIDParam: "space_id", PathTemplate: "/spaces/{space_id}/environments/{environment_id}/content_types"},
		{Name: "delivery_entries", ParentTable: "spaces", ParentIDParam: "space_id", PathTemplate: "/spaces/{space_id}/environments/{environment_id}/entries"},
		{Name: "delivery_sync", ParentTable: "spaces", ParentIDParam: "space_id", PathTemplate: "/spaces/{space_id}/environments/{environment_id}/sync"},
		{Name: "entries", ParentTable: "spaces", ParentIDParam: "space_id", PathTemplate: "/spaces/{space_id}/environments/{environment_id}/entries"},
		{Name: "entry_snapshots", ParentTable: "spaces", ParentIDParam: "space_id", PathTemplate: "/spaces/{space_id}/environments/{environment_id}/entries/{entry_id}/snapshots"},
		{Name: "environments", ParentTable: "spaces", ParentIDParam: "space_id", PathTemplate: "/spaces/{space_id}/environments"},
		{Name: "organization_memberships", ParentTable: "organizations", ParentIDParam: "organization_id", PathTemplate: "/organizations/{organization_id}/organization_memberships"},
		{Name: "preview_api_keys", ParentTable: "spaces", ParentIDParam: "space_id", PathTemplate: "/spaces/{space_id}/preview_api_keys"},
		{Name: "preview_assets", ParentTable: "spaces", ParentIDParam: "space_id", PathTemplate: "/spaces/{space_id}/environments/{environment_id}/assets"},
		{Name: "preview_entries", ParentTable: "spaces", ParentIDParam: "space_id", PathTemplate: "/spaces/{space_id}/environments/{environment_id}/entries"},
		{Name: "releases", ParentTable: "spaces", ParentIDParam: "space_id", PathTemplate: "/spaces/{space_id}/environments/{environment_id}/releases"},
		{Name: "roles", ParentTable: "spaces", ParentIDParam: "space_id", PathTemplate: "/spaces/{space_id}/roles"},
		{Name: "space_memberships", ParentTable: "spaces", ParentIDParam: "space_id", PathTemplate: "/spaces/{space_id}/space_memberships"},
		{Name: "tags", ParentTable: "spaces", ParentIDParam: "space_id", PathTemplate: "/spaces/{space_id}/environments/{environment_id}/tags"},
		{Name: "tasks", ParentTable: "spaces", ParentIDParam: "space_id", PathTemplate: "/spaces/{space_id}/environments/{environment_id}/entries/{entry_id}/tasks"},
		{Name: "webhook_calls", ParentTable: "spaces", ParentIDParam: "space_id", PathTemplate: "/spaces/{space_id}/webhooks/{webhook_id}/calls"},
		{Name: "webhooks", ParentTable: "spaces", ParentIDParam: "space_id", PathTemplate: "/spaces/{space_id}/webhook_definitions"},
	}
}

// syncDependentResources iterates parent tables and syncs child resources per parent ID.
func syncDependentResources(c *client.Client, db *store.Store, sinceTS string, full bool, maxPages int) []syncResult {
	var results []syncResult
	for _, dep := range dependentResourceDefs() {
		res := syncDependentResource(syncClientForResource(c, dep.Name), db, dep, sinceTS, full, maxPages)
