...
but do not stop the import.`,
  ...
  contentful-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  contentful-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | contentful-pp-cli import <resource> --input -`,
